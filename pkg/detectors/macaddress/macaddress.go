...
var (
	...
	keyPat = regexp.MustCompile(detectors.PrefixRegex([]string{"macaddress"}) + `\b([a-zA-Z0-9_]{32})\b`)
)
...
// FromData will find and optionally verify Macaddress secrets in a given set of bytes.
